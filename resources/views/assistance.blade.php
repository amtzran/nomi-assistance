        ...
        <div class="modal fade" id="myModalReport" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <form method="POST" enctype="multipart/form-data" action="{{ Route('assistance_file_upload')}}" role="form">
                            {{ csrf_field() }}
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col form-check">
                                        <input class="form-check-input" type="radio" name="exampleRadios" id="todayRadio" value="option1" checked>
                                        <label class="form-check-label" for="exampleRadios1">
                                            Hoy
                                        </label>
                                    </div>
                                    <div class="col form-check">
                                        <input class="form-check-input" type="radio" name="exampleRadios" id="allRadio" value="option2">
                                        <label class="form-check-label" for="exampleRadios2">
                                            Todo
                                        </label>
                                    </div>
                                    <div class="col form-check mb-2">
                                        <input class="form-check-input" type="radio" name="exampleRadios" id="dateRadio" value="option3">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col">
                                        <input type="date" id="date_initial" name="date_initial" required="required" class="form-control">
                                    </div>
                                    <div class="col">
                                        <input type="date" id="date_final" name="date_final" required="required" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
