                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col form-check">
                            <select id="selectEmployees" class="form-control">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                <input type="date" id="date_initial_hour" name="date_initial" class="form-control">
                            </div>
                            <div class="col">
                                <input type="date" id="date_final_hour" name="date_final" class="form-control">
                            </div>
                        </div>
                    </div>
